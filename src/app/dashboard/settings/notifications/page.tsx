      ...
      <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-xl p-8">
        ...
        <div className="mb-8">
          ...
          <div className="space-y-4">
            <div>
              <label htmlFor="email-notify" className="block text-sm font-medium text-gray-600">
                Email Notification
              </label>
              <select
                id="email-notify"
            ...
            <div>
              <label htmlFor="sms-notify" className="block text-sm font-medium text-gray-600">
                SMS Notifications
              </label>
              <select
                id="sms-notify"
            ...
            <div>
              <label htmlFor="push-notify" className="block text-sm font-medium text-gray-600">
                Push Notification
              </label>
              <select
                id="push-notify"
